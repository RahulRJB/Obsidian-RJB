...
- #### Idea of RCNN:
	...
	- ![[Attachments/Pasted image 20240911124754.png]]How this work? 
our selective search algorithm gives us

a region proposal described by PX

pyph and PW

and our final output of our neural

network generates a transform Vector TX

t y t h and TW

and our goal is to find this outputs

described as bxby pH and BW

basically it can be done using two

operations

first one is called translation

it generates BX by moving the original

Pigs by pwtw

so if pwtw is negative it moves it to

the left and if it is positive it moves

it to the right

similarly VY is generated by moving py

by phth

[Music]

the other operation is called log space

scale transfer

and it rear scales the width by

multiplying the original PW and the

exponential of TW

y exponential because TWU might be a

negative value and we don't have any

negative width so this way we make sure

it's always positive

and similarly the height can be computed

this way

okay we now know the general idea
